  ...
  return (
    <main className="p-5 pb-20 w-full">
      <header className="my-12 flex flex-col items-center justify-center">
        <h1 className="text-4xl md:text-7xl font-bold text-zinc-800">Products</h1>
        <p className="text-lg md:text-2xl text-zinc-600 mt-2">Browse our selection of products</p>
      </header>
      <section>
        <div className="p-3 flex flex-col-reverse md:flex-row justify-between gap-4">
          <div className="flex flex-row flex-wrap justify-end items-center gap-4">
            ...
            <div className="flex flex-row gap-2 items-center">
              ...
              <select
                ...
                className="rounded-full py-2 text-xs md:text-sm text-zinc-900 cursor-pointer focus:outline-none"
              >
                ...
                <Link key={id} href={`/products/${id}`} className="group">
                  ...
                  >
                    ...
                    <div className="text-center flex flex-col justify-between items-center gap-1 md: gap-2">
                      <h3 className="text-sm md:text-xl text-zinc-800 font-semibold line-clamp-2">{title}</h3>
                      <p className="text-zinc-800 text-xs md:text-lg font-medium">${price}</p>
                      <div className="flex flex-row items-end justify-center gap-1 hidden md:block">
